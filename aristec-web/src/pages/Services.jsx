        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <motion.div whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link to="/contacto" className="inline-flex items-center px-12 py-6 bg-primary-700 text-white font-bold rounded-2xl hover:bg-primary-600 transition-all duration-300 shadow-2xl shadow-primary-700/20 active:scale-95 group text-lg">
