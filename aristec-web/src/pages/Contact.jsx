...
const Contact = () => {
  ...
  const inputClasses = (name) => `
    w-full px-8 py-5 rounded-2xl border transition-all duration-500 outline-none font-medium
    ${focusedField === name
      ? 'bg-slate-900 border-primary-500 shadow-[0_0_30px_-5px_rgba(0,101,147,0.4)] text-white'
        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-16 lg:gap-32">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-12">
              {[
                { icon: <Mail />, label: "Email Corporativo", val: "proyectos@aristec.es", color: "text-primary-600" },
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
              ...
              <div className="flex items-center mb-4 text-secondary-400">
                ...
                <span className="text-xs font-black uppercase tracking-widest">Compromiso ArisTec</span>
              </div>
          ...
          {/* Form Area - Command Center Theme */}
          <motion.div
          ...
          >
            ...
            <div className="absolute -inset-4 bg-gradient-to-tr from-primary-500/20 via-secondary-500/20 to-primary-500/20 rounded-[3.5rem] blur-2xl opacity-50 animate-pulse" />

            <div className="relative bg-slate-950 p-8 md:p-14 rounded-[3rem] shadow-2xl border border-white/5 backdrop-blur-3xl overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                {isSubmitted ? (
                  ...
                  >
                    <div className="w-24 h-24 bg-primary-500/10 rounded-full flex items-center justify-center mb-8 mx-auto border border-primary-500/20">
                      <CheckCircle2 className="w-12 h-12 text-secondary-400" />
                    </div>
                    <h2 className="text-3xl font-black text-white mb-4 italic tracking-tight">Transmisión Completa</h2>
                    <p className="text-slate-400 text-lg max-w-sm mx-auto font-medium">Hemos recibido tu reporte. Un especialista se pondrá en contacto contigo brevemente.</p>
                  </motion.div>
                ) : (
                  <motion.form
                    key="form"
                  ...
                  >
                    <div className="flex items-center justify-between mb-8">
                      <h2 className="text-2xl font-black text-white tracking-tight uppercase italic">Nueva Solicitud</h2>
